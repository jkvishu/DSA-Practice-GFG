<h2><a href="https://practice.geeksforgeeks.org/problems/celsius-to-fahrenheit-conversion5212/1">Celsius to Fahrenheit Conversion</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a temperature in celsius <strong>C</strong>. You have to convert it in <strong>Fahrenheit</strong>.</span><br>
&nbsp;</p>
