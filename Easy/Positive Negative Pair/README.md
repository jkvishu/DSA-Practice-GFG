<h2><a href="https://practice.geeksforgeeks.org/problems/positive-negative-pair5209/1">Positive Negative Pair</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array of distinct integers, find all the pairs having both negative and positive values of a number in the array.</span></p>
