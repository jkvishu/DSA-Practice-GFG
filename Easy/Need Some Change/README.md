<h2><a href="https://practice.geeksforgeeks.org/problems/need-some-change/1?page=2&difficulty[]=0&status[]=unsolved&sortBy=submissions">Need Some Change</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>arr&nbsp;</strong>of <strong>n&nbsp;</strong>positive integers. The task is to swap every <strong>i<sup>th</sup></strong> element of the array with <strong>(i+2)</strong><sup>th</sup> element.</span></p>
