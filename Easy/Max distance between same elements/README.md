<h2><a href="https://practice.geeksforgeeks.org/problems/max-distance-between-same-elements/1?page=2&difficulty[]=0&status[]=unsolved&sortBy=submissions">Max distance between same elements</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:20px">Given an array with repeated elements, the task is to find the maximum distance between two occurrences of an element.</span></p>
