<h2><a href="https://practice.geeksforgeeks.org/problems/flattening-a-linked-list/1?page=7&curated[]=1&sortBy=submissions">Flattening a Linked List</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Linked List of size N, where every node represents a sub-linked-list and contains two pointers:<br>
