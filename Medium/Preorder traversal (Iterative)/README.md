<h2><a href="https://practice.geeksforgeeks.org/problems/preorder-traversal-iterative/1?page=1&curated[]=6&sortBy=submissions">Preorder traversal (Iterative)</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a binary tree. Find the preorder traversal of the tree <strong>without using recursion</strong>.</span></p>
