<h2><a href="https://www.geeksforgeeks.org/problems/shortest-path-in-undirected-graph-having-unit-distance/1">Shortest path in Undirected Graph</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given an <strong>Undirected Graph</strong> having <strong>unit weight</strong>, Find the <strong>shortest path from src to all the vertex</strong> and if it is <strong>unreachable</strong> to reach any vertex, then <strong>return -1</strong> for that vertex.</span></p>
